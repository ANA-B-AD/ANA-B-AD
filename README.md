...
<style>
  .image-container img {
    width: 100px; /* Задайте ширину 100 пикселей */
    height: 100px; /* Задайте высоту 100 пикселей */
    object-fit: cover; /* Сохраняет пропорции изображения, обрезая его при необходимости */
  }
</style>
